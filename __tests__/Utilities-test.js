...
describe('  utils', function () {
  describe('.PivotData()', function () {
    ...
    describe('with rows/cols and subtotals', function () {
      ...
      it('has correctly-ordered row keys', function () {
        return expect(pd.getRowKeys()).toEqual([['Carol'], ['Carol', 'yellow'], ['Jane'], ['Jane', 'red'], ['John'], ['John', 'blue'], ['Nick'], ['Nick', 'blue']]);
      });

      it('has correctly-ordered col keys', function () {
        return expect(pd.getColKeys()).toEqual([[95, 25], [95], [102, 14], [102], [103, 12], [103], [112, 30], [112]]);
      });
      ...
      it('can be iterated over', function () {
        ...
        try {
          for (var _iterator3 = Array.from(pd.getRowKeys())[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var r = _step3.value;
            ...
            try {
              for (var _iterator4 = Array.from(pd.getColKeys())[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var c = _step4.value;
      ...
      it('has a correct spot-checked aggregator #2', function () {
        var agg = pd.getAggregator(['John'], [112, 30]);
        var val = agg.value();
        expect(val).toBe(1);
        expect(agg.format(val)).toBe('1');
      });
      ...
      it('has a correct spot-checked aggregator #3', function () {
        var agg = pd.getAggregator(['Jane', 'red'], [102]);
        var val = agg.value();
