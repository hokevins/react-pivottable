  ...
  _createClass(PivotTableUI, [{
    ...
    value: function rendererCell() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Dropdown, {
          current: this.props.rendererName in this.props.renderers ? this.props.rendererName : Object.keys(this.props.renderers)[0],
      ...
      return _react2.default.createElement(
        ...
        new Array(numValsAllowed).fill().map(function (n, i) {
          return [_react2.default.createElement(Dropdown, {
            ...
            values: Object.keys(_this9.attrValues).filter(function (e) {
    ...
    value: function render() {
      ...
      var unusedAttrs = Object.keys(this.attrValues).filter(function (e) {
        return !_this10.props.rows.includes(e) && !_this10.props.cols.includes(e) && !_this10.props.hiddenAttributes.includes(e) && !_this10.props.hiddenFromDragDrop.includes(e);
      ...
      var unusedAttrsCell = this.makeDnDCell(unusedAttrs, function (order) {
        return _this10.setState({ unusedOrder: order });
      }, 'pvtAxisContainer pvtUnused ' + (horizUnused ? 'pvtHorizList' : 'pvtVertList'));

      var colAttrs = this.props.cols.filter(function (e) {
        return !_this10.props.hiddenAttributes.includes(e) && !_this10.props.hiddenFromDragDrop.includes(e);
      });
      ...
      var outputRows = horizUnused ? [_react2.default.createElement(
        'tr',
        { key: 'R' },
        this.rendererCell(),
        unusedAttrsCell
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'tbody',
          { onClick: function onClick() {
              return _this10.setState({ openDropdown: false });
            } },
          outputRows
        )
      );
